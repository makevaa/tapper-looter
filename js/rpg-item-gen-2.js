...
const rpgItemGen = {
    ...
    item: {
        ...
        artifact: {
             names: ["talisman", "charm", "heart", "relic", "totem", "icon", "idol", "boon", "token", "tribute", "heirloom", "gift", "bond", "oath", "pledge", "soul", "memory", "hope", "incarnation", "legacy", "insignia", "seal", "vestige", "fable", "prayer", "song", "glory", "might", "fortitude", "force", "litany", "requiem", "covenant", "whisper", "words", "warcry","zeal", ],
        },
        axe: {
             names: ["axe", "edge", "war axe", "battle axe", "broadaxe", "warblade", "cleaver", "chopper", "crescent", "greataxe", "reaver", "ravager", "carver","tabar","decapitator" ],
        },  
        bow: {
	...
	"epicNouns": [
		"skies","depths","dimensions","dreams","dynasties","empires","immortals","iron","legions","light","overworlds","realms","souls","underworlds","war","worlds","creation","empyrean","grace","immortality","infinity","invincibility","lies","madness","malady","maladies","malice","order","peace","secrets","shadows","solitude","stars","truths","war","wishes","warfare","void","spirit","shadow","serpent","titan","paragon","horizon","star","hope","fire","mercy","excess","glory","justice","sorrow","talons","wrath","horizons","forests","jade","magnetism","progress","blight","void","perseverance","moon","guardian","aether","malevolence","sky","sun","winter","seasons","ages","heaven","freedom","pain","torment","agony","triumph","earth","valhalla","hyperborea","north","magick","fate","hellfire","grandeur","hatred","witchcraft","witchery","storm","snake","wind","annihilation", "devastation", "nightmare", "meteor", "solitude", "mirage", "ragnarok", "massacre", "dawn", "twilight", "magic", "deception", "eternity", "insanity", "torment", "despair", "extinction", "affliction","envy","fervor","passion", "carnage","bliss","truth","honor","prosperity","glacier","knowledge","daring","thunder","scarlet","balance","greed","sustenance","vita","life","venom","pestilence","incineration","fortitude"
	],
